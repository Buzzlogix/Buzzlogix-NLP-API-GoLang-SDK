 ...
 */
func (me *TWITTERSENTIMENT_IMPL) CreateReturnEnglishTwitterSentimentPlaintext (
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *TWITTERSENTIMENT_IMPL) CreateReturnEnglishTwitterSentimentMultipartForm (
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *TWITTERSENTIMENT_IMPL) CreateReturnEnglishTwitterSentimentEncodedForm (
