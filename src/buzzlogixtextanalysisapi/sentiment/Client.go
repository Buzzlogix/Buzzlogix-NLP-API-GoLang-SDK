 ...
 */
func (me *SENTIMENT_IMPL) CreateReturnEnglishGeneralSentimentPlaintext (
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *SENTIMENT_IMPL) CreateReturnEnglishGeneralSentimentMultipartForm (
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *SENTIMENT_IMPL) CreateReturnEnglishGeneralSentimentEncodedForm (
